...
pdf("manuscript/01_figures/fig01_descriptive.pdf", width = 8.3, height = 11.7)
...
for (i in 1:length(states)) {
  ...
  plot(data_sub$date, data_sub$avgmeantemp, 
       ...
       ylab = "", xlab = "Date", 
       xaxt = ifelse(i == length(states), "s", "n"),
